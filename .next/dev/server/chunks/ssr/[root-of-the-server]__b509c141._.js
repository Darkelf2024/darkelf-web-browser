...
const metadata = {
    ...
    description: "Browse all Darkelf browser releases: Darkelf Cocoa (macOS), Darkelf Shadow (Linux/Windows), Darkelf Mini Browser (Tor-native, all platforms), and Darkelf OSINT AI. Filter by product, channel, and platform. SHA-256 verified.",
    keywords: [
        'Darkelf releases',
        'Darkelf Cocoa releases',
        'Darkelf Shadow releases',
        'Darkelf Mini Browser releases',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b509c141._.js.map